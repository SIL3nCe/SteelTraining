...
cd %BUILD_DIR%
	...
	cmake -G %GENERATOR% -DShSDK_DIR="%DEVLINE_DIR%/Build/Win32_x86_VS2017_DX11/cmake/lib/x86/ShSDK" -DShSDK_Editor_DIR="%DEVLINE_DIR%/Build/Win32_x86_VS2017_DX11/cmake/lib/x86/ShSDK_Editor" -DSHINE_INTERNAL=1 -DSHINE_EDITOR_EXT_DIR="%DEVLINE_DIR%/Build/Win32_VS2017/Compiled/Bin/x86/Extensions" -DCMAKE_CONFIGURATION_TYPES=Debug;Release;Master ..
